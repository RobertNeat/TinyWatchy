...
- `WATCHFACE > BTN Layout` changes the active button map between `0`, `1`, `2`, and `3`; the choice is stored in NVS, while `BUTTON_MAP` remains the default for a fresh installation.
